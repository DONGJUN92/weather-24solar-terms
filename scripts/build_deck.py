...
c.setFont("MG", 10); c.setFillColorRGB(*MUTED)
c.drawString(48, 51, "발견 경로 · AI 레드팀 4라운드 · 3라운드 44건 + 4라운드 40건 적발 → 전량 수정 · AI 주장 11건은 원자료 재검증으로 기각")
foot("검증")

# ── 7. 재발 방지 ──────────────────────────────────────────────
c.showPage(); bg()
head("재발 방지", "같은 실수가 돌아오지 못하게", "검증 스크립트가 배포 전에 차단")
big(72, H - 216, "8,303", "총 검사 · 데이터 8,213 + 계약/문서 90", SEA, 46)
